...
<div class="page-container">
    ...
    <input type="text" name="userId" 
       <c:if test="${!(role == 'ROLE_DOCTOR' || role == 'ROLE_CUSTOMER')}">disabled</c:if> 
       required />

        Password: <input type="password" name="password" /><br/>
        Report ID: <input type="text" name="reportId" /><br/>
         <button type="submit">View Report</button>
         <a href="/viewReportServlet" class="button-link">View Report</button>
         <button type="reset" class="reset">Reset</button>
    </form>
 <a class="button-link" href="/home">Back to Home</a></body>
 </div>
</html>
